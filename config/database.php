    ...
    */
    ...
    'connections' => [
        ...
        'cp' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('CP_DB_HOST', '127.0.0.1'),
            'port' => env('CP_DB_PORT', '3306'),
            'database' => env('CP_DB_DATABASE', 'forge'),
            'username' => env('CP_DB_USERNAME', 'forge'),
        ...
        'plugin' => [
            ...
            'database' => env('PLUGIN_DB_DATABASE', 'forge'),
            'username' => env('PLUGIN_DB_USERNAME', 'forge'),
